...
function Hero({ user }) {
	const greetingText = `Good afternoon, Mr. ${user.firstName} ${user.lastName}`;
	return (
	...
	return (
		<Card css={{ bg: "$colors$darkpurple", mw: "100%" }}>
			...
			<Card.Body css={{ py: "$10" }}>
				...
				<Text css={{ color: "blue" }}>Change email</Text>
				<Spacer></Spacer>
				<Text css={{ color: "$white" }} h3>
					Password ******************
				</Text>
				<Text css={{ color: "blue" }}>Change password</Text>
			</Card.Body>
		</Card>
	);
}
