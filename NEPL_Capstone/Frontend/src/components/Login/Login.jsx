					...
					<Card.Body css={{ py: "$10", marginBottom: "-2vh" }}>
						<Grid.Container justify="center" gap={2}>
							...
							{errors?.form ? (
								<>
									<Grid css={{ marginTop: "-1vh" }}>
										<Text color="error">{errors.form}</Text>
									</Grid>
								</>
							) : (
								<></>
							...
							<Grid>
								<Link
									color="inherit"
									href="https://slack.com/openid/connect/authorize?scope=openid%20email%20profile&amp;response_type=code&amp;redirect_uri=https%3A%2F%2Fsecuritea.surge.sh%2Fslack&amp;client_id=3765144863393.3898834395927"  
									target="_blank"
								>
									<Button
										color="secondary"
							...
							<Grid>
								<Text
									css={{ textAlign: "right", marginTop: "-1.5vh" }}
									size={15}
									weight=""
								>
